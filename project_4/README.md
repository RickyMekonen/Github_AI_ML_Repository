...
- Previous campaigns (number of contacts during the previous campaign)
- Day of the month
...
- Dataset source: [Bank Marketing Dataset](https://www.kaggle.com/datasets/uciml/bank-marketing)
- Thanks to the contributors and open-source community for the tools used in this project.
